...
var cityContactsHeader = document.querySelector('[data-city-tabs] [data-city-header]'); // const API_KEY = '3af947368395bd318640a7cea988f178';
...
function _getWeatherData() {
  _getWeatherData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id, element) {
    var response, city, temperature;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch("https://api.openweathermap.org/data/2.5/weather?id=".concat(id, "&appid=").concat(API_KEY));
