...
/* harmony import */ var _modules_init_city_map__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./modules/init-city-map */ "./js/modules/init-city-map.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_city_map__WEBPACK_IMPORTED_MODULE_25__["initContactsCity"])();
    ...
    videos.forEach(function (video) {
      var breakpointChecker = function breakpointChecker() {
        if (video.dataset.src) {
          video.src = video.dataset.src; // video.play();
        } else {
          if (breakpoint.matches) {
